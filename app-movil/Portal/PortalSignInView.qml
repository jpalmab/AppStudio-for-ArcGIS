...
Rectangle {
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    Loader {
                        ...
                        sourceComponent: portal.pkiAuthentication ?
                                             pkiSignOnView :
                                             portal.singleSignOn ?
                                                 singleSignOnView :
                                                 useOAuth ?
                                                     useExternalUserAgent ?
    ...
    Component {
        ...
        PKISignInView {
            ...
            pkiFile: portal.rememberMe ? portal.pkiFile : ""
            pkiFileName: portal.rememberMe ? portal.pkiFileName : ""
            passPhrase: portal.rememberMe ? portal.passPhrase : ""
            rememberMe: portal.rememberMe
    ...
    Component {
        ...
        BuiltInSignInView {
            ...
            username: portal.rememberMe ? portal.username : ""
            password: portal.rememberMe ? portal.password : ""
            saveUserChecked: portal.rememberMe
            fontFamily: signInView.fontFamily
