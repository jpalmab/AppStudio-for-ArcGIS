...
*/
    ...
    XFormMenuPanel {
        ...
        menu: Menu {
            ...
            MenuItem {
                text: codeScanViewPage.decodeHints !== -1 ? qsTr("Select all") : qsTr("Select none")
                checkable: true
                checked: false
                ...
                onTriggered: {
                    if (codeScanViewPage.decodeHints !== -1) {
                        ...
                        codeScanViewPage.decodeHints = 0;
                    }
                }
            }
        }
        ...
        Component {
            ...
            MenuItem {
                ...
                onTriggered: {
                    ...
                    if (codeScanViewPage.decodeHints & BarcodeDecoder.DecodeHintPDF_417) {
                        if (decodeHint === BarcodeDecoder.DecodeHintPDF_417) {
                            codeScanViewPage.decodeHints = BarcodeDecoder.DecodeHintPDF_417;
                        } else {
                            codeScanViewPage.decodeHints &= ~BarcodeDecoder.DecodeHintPDF_417;
                        }
                    }
